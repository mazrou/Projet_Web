        ...
        <div class="col-sm-6">
         ...
         <form action="?action=login" method="post" id="loginForm" class="mt-4 shadow">
          ...
          <form action="?action=listtc&user_id=<?= $user_id ?>" class="shadow" id="ddt" method="POST" enctype="multipart/form-data">
            <div class="container">
              <h1>Postez votre marchendizey  </h1>
              ...
              <label for="tot1"><b> lieu de depart  </b></label>
              <input name="tot1" type="text">
              <br>
              <label for="tot1"><b> lieu de darive  </b></label>
              <input name="tot1" type="text">
              <br>
              <label for="type"><b>Le poids de votre marchendise</b></label>
              <input name ="type" type="text">
           
              <br>
              <label for="file">Ajouter des photos</label>
              <input type="file" class="form-control-file p-3" id="exampleFormControlFile1" name="file" required>
              <TEXTAREA name="com" class="p-3 mb-3" rows=4 cols=40>Description</TEXTAREA>
              <div class="clearfix">
