   ...
   <div id="demo" class="carousel slide mt-5 mb-5  " data-ride="carousel"  data-interval="3000" >
        ...
        <div class="col-sm-12">
            ...
            <tr>    
                    ...
                    <td>Tel</td>
                    <td>Fax</td>
                    <td>nombre de documents traduisé</td>
                ...
                <tr>
                    ...
                    <td><button ><a href="?action=choisir&user_id=<?= $_GET['user_id']?>&traducteur_id=<?=$r['id']?>&nom=<?=$_POST['nom']?>&prenom=<?=$_POST['prenom']?>&email=<?=$_POST['email']?>&numero=<?=$_POST['numero']?>&adress=<?=$_POST['adress']?>&origine=<?=$_POST['tot1']?>&source=<?=$_POST['tot2']?>&type=<?=$_POST['type']?>&assermente=<?=$_POST['tot3'] ?>&com=<?=$_POST['com']?>">Choisir</a></button></td> 
